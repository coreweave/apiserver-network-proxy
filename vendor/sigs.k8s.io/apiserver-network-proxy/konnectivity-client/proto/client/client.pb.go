...
const (
	...
	PacketType_DATA_ACK  PacketType = 7
)
...
func (x *Packet) GetDataAck() *DataAck {
	if x, ok := x.GetPayload().(*Packet_DataAck); ok {
		return x.DataAck
	}
	return nil
}
...
type Packet_DataAck struct {
	DataAck *DataAck `protobuf:"bytes,9,opt,name=dataAck,proto3,oneof"`
}
...
type DialRequest struct {
	...
	// TODO: currently not used, as for throttling agent -> server
	// - added by server to inform agent
...
func (x *DialRequest) GetWindowSize() int64 {
	if x != nil {
		return x.WindowSize
	}
	return 0
...
type DialResponse struct {
	...
	Random int64 `protobuf:"varint,3,opt,name=random,proto3" json:"random,omitempty"`
	// window size for flow control
	// - this is how the agent informs the sender about the capacity of it's receive window (impl. via semaphore of the same size)
	WindowSize int64 `protobuf:"varint,4,opt,name=windowSize,proto3" json:"windowSize,omitempty"`
}
...
func (x *DialResponse) GetWindowSize() int64 {
	if x != nil {
		return x.WindowSize
	}
	return 0
...
// ACK message usable for both directions
type DataAck struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DataAck) GetConnectID() int64 {
	if x != nil {
		return x.ConnectID
	}
	return 0
...
var file_konnectivity_client_proto_client_client_proto_rawDesc = []byte{
	...
	0x97, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x1f, 0x0a, 0x04, 0x74, 0x79,
	...
	0x00, 0x52, 0x05, 0x64, 0x72, 0x61, 0x69, 0x6e, 0x12, 0x24, 0x0a, 0x07, 0x64, 0x61, 0x74, 0x61,
	0x41, 0x63, 0x6b, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x44, 0x61, 0x74, 0x61,
	0x41, 0x63, 0x6b, 0x48, 0x00, 0x52, 0x07, 0x64, 0x61, 0x74, 0x61, 0x41, 0x63, 0x6b, 0x42, 0x09,
	0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x7b, 0x0a, 0x0b, 0x44, 0x69, 0x61,
	0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x74,
	...
	,
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x49, 0x44, 0x22, 0x23,
	0x0a, 0x09, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x44, 0x69, 0x61, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x72,
	0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x72, 0x61, 0x6e,
	0x64, 0x6f, 0x6d, 0x22, 0x07, 0x0a, 0x05, 0x44, 0x72, 0x61, 0x69, 0x6e, 0x22, 0x4e, 0x0a, 0x04,
	0x44, 0x61, 0x74, 0x61, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x49,
	0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	...
	,
...
var file_konnectivity_client_proto_client_client_proto_depIdxs = []int32{
	...
	5,  // 8: Packet.dataAck:type_name -> DataAck
